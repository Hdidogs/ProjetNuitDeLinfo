...
<div class="container text-center">
    <h2 class="display-4 text-white mb-3 animated slideInDown">Categories : La pollution</h2>
</div>
<div class="container-fluid py-5">
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid animated pulse infinite" src="../assets/Air-Pollution-PNG-Clipart.png">
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">

                    <?php
                    $bdd = $co->conbdd();
                    $req = $bdd->prepare("SELECT * FROM reponse INNER JOIN question ON reponse.ref_question = question.id_question WHERE ref_quizz = 3;");
                    $req->execute();
